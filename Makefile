#############################################################################
# Makefile for building: PenguSniff
# Generated by qmake (3.0) (Qt 5.2.1)
# Project:  PenguSniff.pro
# Template: app
# Command: /usr/lib/x86_64-linux-gnu/qt5/bin/qmake -o Makefile PenguSniff.pro
#############################################################################
...
Makefile: PenguSniff.pro /usr/lib/x86_64-linux-gnu/qt5/mkspecs/linux-g++-64/qmake.conf /usr/lib/x86_64-linux-gnu/qt5/mkspecs/features/spec_pre.prf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/shell-unix.conf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/unix.conf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/linux.conf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/gcc-base.conf \
...
dist: 
	@test -d .tmp/PenguSniff1.0.0 || mkdir -p .tmp/PenguSniff1.0.0
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/PenguSniff1.0.0/ && $(COPY_FILE) --parents Headers/getfiletotal.h Headers/mainwindow.h Headers/worker.h .tmp/PenguSniff1.0.0/ && $(COPY_FILE) --parents Sources/main.cpp Sources/mainwindow.cpp .tmp/PenguSniff1.0.0/ && $(COPY_FILE) --parents mainwindow.ui .tmp/PenguSniff1.0.0/ && (cd `dirname .tmp/PenguSniff1.0.0` && $(TAR) PenguSniff1.0.0.tar PenguSniff1.0.0 && $(COMPRESS) PenguSniff1.0.0.tar) && $(MOVE) `dirname .tmp/PenguSniff1.0.0`/PenguSniff1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/PenguSniff1.0.0
